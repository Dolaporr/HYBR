...
export const alitheiaCaseStudy: CaseStudyListing = {
  ...
  body: "How HYBR helped Alitheia Capital assess the operational and technical readiness of a prospective investment and uncover what it would take to scale.",
...
export const alitheiaEditorial = {
  title: "Beyond the Numbers",
  subtitle: "How HYBR helped Alitheia Capital assess the operational and technical readiness of a prospective investment and uncover what it would take to scale.",
  facts: [
    ["Client", "Alitheia Capital"],
    ["Sector", "Impact Investment"],
    ["Focus", "Investment readiness"],
    ["HYBR practice", "Discover"],
    ["Capability", "Business Diagnostics"],
  ],
  intro: "Capital can accelerate a business. But only if the business is ready to absorb it.",
  sections: [
    {
      title: "The context: looking beyond financial performance",
      copy: [
        "Alitheia Capital is an Africa-focused impact investment and private equity firm that backs high-potential businesses while pursuing measurable financial and social returns. Through Alitheia IDF, its gender-lens investment fund, the firm invests in high-growth businesses where women play significant roles as founders, leaders, employees, participants in the value chain or customers.",
        "As Alitheia evaluated a significant investment in a female-led food company, it needed to look beyond financial performance. The question was whether the company's operations, technical capabilities and underlying systems were ready for the next stage of growth.",
      ],
    },
    {
      title: "Know what it takes to scale before putting capital to work",
      copy: [
        "Alitheia needed an independent view of the business behind the numbers: what was working, where material risks existed, what could constrain growth, and what capabilities would need to improve as the company scaled.",
        "Getting that view required more than conventional financial due diligence. It required deep operational assessment, relevant food-industry expertise and the ability to mobilise quickly within the timetable of an active investment process.",
      ],
    },
    {
      title: "Bring the right expertise to the table - fast",
      copy: [
        "Through its Business Diagnostics capability within the Discover practice, HYBR rapidly assembled a multidisciplinary team combining operational, commercial and food-industry expertise.",
        "The team conducted a robust operational and technical diagnostic of the prospective investee company, examining how the business worked today and what would be required for it to operate successfully at greater scale.",
        "HYBR translated the evidence into clear findings on operational strengths, potential risks, scale constraints and opportunities for improvement. The team also developed practical strategic recommendations that could strengthen the business after investment.",
      ],
    },
    {
      title: "What the work made possible",
      copy: [
        "HYBR gave Alitheia a clearer view of the operating realities behind the investment opportunity. The diagnostic provided an independent evidence base to inform investment deliberations, greater visibility into operational and technical risks, and a clearer understanding of the company's ability to scale.",
        "It also provided actionable recommendations for strengthening the business and guiding post-investment optimisation. The result was more than a due-diligence report: it gave Alitheia a clearer view of both the investment in front of it and the work required to unlock its potential.",
      ],
    },
  ],
};
